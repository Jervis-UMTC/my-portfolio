...
import { PROJECTS, TECH_HEX } from "../lib/constants";

const getProjectTechStyle = (tech: string) => {
  const hex = TECH_HEX[tech];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {PROJECTS.map((project, index) => (
          <motion.div
            ...
            className="flex flex-col group items-start p-6 rounded-2xl bg-gray-50 dark:bg-zinc-900/50 hover:bg-white dark:hover:bg-zinc-900 border border-transparent hover:border-blue-200/60 dark:hover:border-blue-800/40 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
          >
